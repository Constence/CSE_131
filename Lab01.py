...
#      This assignment went well. Coding it was fairly simple, but it just took some time to come up with the logic for running the game in play_game().
# 5. How long did it take for you to complete the assignment?
#      This took me 2 hours in total to complete
#######
